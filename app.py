...
if generate_btn:
    if topic:
        ...
        if result and result.raw:
            with st.spinner("🎨 Generating educational diagram..."):
        ...
        with col1:
            ...
            if result and result.raw:
                ...
                st.info("📝 No educational content generated for this topic.")

        with col2:
            st.markdown("""
            <div class="content-card">
                <h3>🖼️ Educational Diagram</h3>
            </div>
            """, unsafe_allow_html=True)
            if image:
                st.image(image, use_container_width=True)
            else:
                st.info("🎭 No diagram generated for this topic.")
